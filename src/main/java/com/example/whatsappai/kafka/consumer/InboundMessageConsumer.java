...
public class InboundMessageConsumer {
    ...
    private final WhatsAppResponseService whatsAppResponseService;
    private final IdempotencyService idempotencyService;
    private final RateLimitService rateLimitService;

    public InboundMessageConsumer(AIOrchestrator aiOrchestrator,
                                  WhatsAppResponseService whatsAppResponseService,
                                  IdempotencyService idempotencyService,
                                  RateLimitService rateLimitService) {
        this.aiOrchestrator = aiOrchestrator;
        this.whatsAppResponseService = whatsAppResponseService;
    ...
    public void receive(WhatsAppMessageEvent event) {
        ...
        whatsAppResponseService.sendReply(message.phoneNumber(), response.answer());
    }
}
